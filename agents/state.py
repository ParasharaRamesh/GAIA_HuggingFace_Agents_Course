...
class AgentState(TypedDict):
    ...
    Attributes:
        ...
        high_level_roadmap (Annotated[List[str], operator.add]):
            ...
            The Planner moves through this roadmap step-by-step.
        ...
        error_message (Optional[str]):
            A detailed message if a critical error occurred that requires the Planner's attention
            beyond a simple retry by the active agent. This signals a need for the Planner
            to potentially adjust the `high_level_roadmap` or select a different agent.
    """
    query: str
